...
class Books extends Component {
  ...
  drawBooks(){
    var bookSection1 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/covers/1.jpg" alt="book6" className="bookCoverImage"/>
      <h5>실전 민사소송법 (그림)</h5>
      ...
      <ul className="list-inline">
        <li><a href="https://www.aladin.co.kr/shop/wproduct.aspx?ISBN=K572639625&start=pnaver_02" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/stores/aladdin.png" className="bookStoreIcon" alt="aladin"/></a></li>
        <li><a href="http://pod.kyobobook.co.kr/podBook/podBookDetailView.ink?ejkGb=KOR&barcode=1400000377208" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/stores/kyobo.png" className="bookStoreIcon" alt="kyobo"/></a></li>
        <li><a href="https://book.naver.com/bookdb/book_detail.nhn?bid=16357665" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/stores/naver.png" className="bookStoreIcon" alt="naver"/></a></li>
        <li><a href="http://www.yes24.com/Product/Goods/90250538" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/stores/yes24.png" className="bookStoreIcon" alt="yes24"/></a></li>
      </ul>
    </div>
    
    var bookSection2 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/covers/2.jpg" alt="book10" className="bookCoverImage"/>
    ...
    var bookSection3 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/covers/3.jpeg" alt="book11" className="bookCoverImage"/>
    ...
    var bookSection4 = <div className="singleBookContainer">
      ...
      <ul className="list-inline">
        <li><a href="https://doi.org/10.979.11958612/00" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/stores/seoji.png" className="bookStoreIcon" alt="aladin"/></a></li>
      </ul>
    </div>

    var bookSection5 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/covers/5.png" alt="book9" className="bookCoverImage"/>
      ...
      <ul className="list-inline">
        <li><a href="https://doi.org/10.978.896489/5344" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/dalawaylee/dalawaylee.github.io/src/images/books/stores/seoji.png" className="bookStoreIcon" alt="kyobo"/></a></li>
